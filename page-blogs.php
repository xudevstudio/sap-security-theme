 ...
 *
 * This template displays all blog posts in a professional grid.
 * If the page slug is "blogs", WordPress will automatically use this file (page-blogs.php).
 */
...
<div class="page-hero">
    <div class="container">
        ...
        <p style="color: #94a3b8; font-size: 1.1rem; max-width: 600px; margin: 1rem auto 0; line-height: 1.6;">
            Explore our latest articles, tutorials, and insights on SAP Security and Administration.
        </p>
    </div>
...
<main id="main" class="site-main page-main">
    <div class="container">
        ...
        <div class="blogs-filter-bar">
            ...
            <div class="blogs-categories">
                ...
                foreach ( $categories as $category ) {
                    ...
                    echo '<a href="' . esc_url( get_category_link( $category->term_id ) ) . '" class="badge badge-' . $color . '" style="margin-right: 8px;">' . esc_html( $category->name ) . '</a> ';
                    $c_index++;
                }
                ?>
            </div>
        ...
        <?php
        // Query to get all blog posts (paginated)
